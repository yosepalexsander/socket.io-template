...
const socketIo = (io) => {
  ...
  io.on("connection", async (socket) => {
    ...
    // event listener with event 'load messages'
    ...
    // event listener with event 'send message'
    socket.on("send message", async (payload) => {
      try {
        ...
        // emit event 'new message notif' to sender and recipient
    ...
    socket.on("disconnect", () => {
      ...
      // delete connected user with key corresponding to userId in memory
